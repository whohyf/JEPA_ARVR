...
SUBMIT_SCRIPT="${SUBMIT_SCRIPT:-${PROJECT_ROOT}/.worktrees/vlm-baseline-1s/scripts/submit_b11_vlm_baseline_1s_p01fixed_rgbonly_probeonly_resumable.sh}"
job_id=""
max_relaunch=8
poll_sec=120
...
first_job_id="${job_id}"
log_file="${PROJECT_ROOT}/logs/watchdog_vlm_baseline_1s_p01fixed_rgbonly_probeonly_${first_job_id}.log"
state_file="${PROJECT_ROOT}/logs/watchdog_vlm_baseline_1s_p01fixed_rgbonly_probeonly_${first_job_id}.state"
